...
import { addDoctor, getAppointmentsByDoctor } from "../controllers/doctorController.js";
import { getAllDoctors , getDoctorById ,cancelDoctor} from "../controllers/doctorController.js";

const router = express.Router();

router.get("/getByDoctor/:id",  authMiddleware, roleMiddleware(["doctor"]), getAppointmentsByDoctor);
